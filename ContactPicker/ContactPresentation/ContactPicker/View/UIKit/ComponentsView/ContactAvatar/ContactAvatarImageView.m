...
- (void)awakeFromNib {
    ...
    [self.mainContentView.layer insertSublayer:gradient atIndex:0];
}
...
- (void)configImage:(UIImage * _Nullable)image forLabel:(NSString *)label withColor:(NSArray * _Nullable)color {
